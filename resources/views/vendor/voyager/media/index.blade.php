...
@section('content')
                ...
                <div id="filemanager">
                    ...
                    <div id="toolbar">
                        ...
                        <div class="btn-group offset-right">
                            ...
                            <button v-show="selected_file.type.includes('image')" type="button" class="btn btn-default" id="crop"><i class="voyager-crop"></i>
                                Crop
                            </button>
                        </div>
                    </div>
                ...
                <div class="modal fade modal-danger" id="confirm_crop_modal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h4>對 '<span class="confirm_crop_name"></span>' 圖片進行裁切.</h4>
                                <div class="crop-container">
                                  <img style="max-width: 100%;" id="cropping-image" class="img img-responsive"/>
                                </div>
                                <div class="new-img-info">
                                  Width: <span id="new-img-width"></span>, Height: <span id="new-img-height"></span>
                                </div>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                <button type="button" class="btn btn-danger" id="confirm_crop">Done
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <input type="hidden" id="img_name" name="img" value="$img->name">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.0.0/cropper.min.js" integrity="sha256-q1lSe2iuxG1LpMHdoYKjXeuzlwtKs7/P12Z3m2TvMcs=" crossorigin="anonymous"></script>
