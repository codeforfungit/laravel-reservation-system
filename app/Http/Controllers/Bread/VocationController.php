...
class VocationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $reservationDateStringArray = array();
        foreach($reservations as $reservation) {
            array_push($reservationDateStringArray, (new \Carbon\Carbon($reservation->start)) -> toDateString());
        }

        $reservationDateStringArray = json_encode($reservationDateStringArray);

        return view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'vocations', 'reservationDateStringArray'));
    }
